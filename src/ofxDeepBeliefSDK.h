#include "libjpcnn.h"
#include "ofMain.h"
#include "ofxDeepBeliefSDKTrain.h"
             ...
             while(isThreadRunning()) {
                if(imageOrTexture == 0) {
                    if(pathimg!=""&&pathnet!="") {
                        ...
                        jpcnn_classify_image(networkHandle, imageHandle, flags, layerOffset, &predictions, &predictionsLength, &predictionsLabels, &predictionsLabelsLength);
                        int count = 0;
